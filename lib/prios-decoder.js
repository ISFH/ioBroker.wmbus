...
//link_layer = { lfield: 25, cfield: 68, address_raw: Buffer.from('a511780779194820', 'hex'), mfield: 4517, afield_raw: Buffer.from('780779194820', 'hex'), afield: 427362168, afield_version: 72, afield_type: 32, manufacturer: 'DME', typestring: 'Breaker (electricity)', afield_id: '19790778' };
//priosDecoder(Buffer.from('A1711500131b68a00580a599a1d57d3a', 'hex'), link_layer, { 7: 'Water' });
