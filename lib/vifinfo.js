...
const VIFEInfo = {
    ...
    VIF_RES_E1111100:             { typeMask: 0b01111111, expMask: 0b00000000, type: 0b01111100, bias:  0, unit: 'Reserved', calcFunc: 'extendDescription', }, // Reserved
...
const VIFInfo_KAM = {
    VIF_ENERGY_E8:                { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00000111, bias:  0, unit: 'kWh', calcFunc: 'numeric', description: 'Heating energy E8', },
    VIF_ENERGY_E9:                { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00001000, bias:  0, unit: 'kWh', calcFunc: 'numeric', description: 'Heating energy E9', },
    VIF_TEMPERATURE_AVG:          { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00001111, bias:  0, unit: '(average)', calcFunc: 'extendDescription', },
    VIF_KAMSTRUP_CONFIG:          { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00010001, bias:  0, unit: '', description: 'Config number (0x11)', },
    VIF_KAMSTRUP_METER_TYPE:      { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00011010, bias:  0, unit: '', description: 'Meter type', },
    VIF_KAMSTRUP_INFO_20:         { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00100000, bias:  0, unit: '', description: 'Info register (0x20)', },
    VIF_KAMSTRUP_INFO_22:         { typeMask: 0b01111111, expMask: 0b00000000, type: 0b00100010, bias:  0, unit: '', description: 'Info register (0x22)', },
};

// catch unknown VIF(E)
const VIFInfo_unknown = {
